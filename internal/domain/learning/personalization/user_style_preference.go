...
type UserStylePreference struct {
	...
	ConceptID *uuid.UUID `gorm:"type:uuid;index:idx_user_style_pref,unique,priority:2" json:"concept_id,omitempty"`

	Modality string `gorm:"column:modality;not null;index:idx_user_style_pref,unique,priority:3" json:"modality"`
	Variant  string `gorm:"column:variant;not null;index:idx_user_style_pref,unique,priority:4" json:"variant"`
