...
type Activity struct {
	...
	Kind  string `gorm:"column:kind;not null;default:'reading';index" json:"kind"` // reading|quiz|drill|case|...
	...
	Difficulty       string `gorm:"column:difficulty;index" json:"difficulty,omitempty"` // easy|med|hard
	Status string `gorm:"column:status;not null;default:'draft';index" json:"status"` // draft|ready|archived
