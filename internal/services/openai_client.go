...
type OpenAIClient interface {
	...
	GenerateTextWithImages(ctx context.Context, system string, user string, images []OpenAIImageInput) (string, error)
}
...
type responsesRequest struct {
	...
	// Per Responses API, "input" is an array of messages. We support string content OR multimodal array content.
	Input []struct {
...
// Extract concatenated output_text blocks
...
func (c *openAIClient) GenerateText(ctx context.Context, system string, user string) (string, error) {
	req := responsesRequest{
		Model: c.model,
		Input: []struct {
			Role    string `json:"role"`
...
func (c *openAIClient) GenerateTextWithImages(ctx context.Context, system string, user string, images []OpenAIImageInput) (string, error) {
	// Build multimodal content array for the user message:
	// [{type:"input_text", text:user}, {type:"input_image", image_url:"...", detail:"low"}...]
