...
var nodeDocMetaScrubRules = []scrubRule{
	...
	{Label: "up next", Re: regexp.MustCompile(`(?i)\bup\s+next\b`), Replacement: "Now"},
	{Label: "next up", Re: regexp.MustCompile(`(?i)\bnext\s+up\b`), Replacement: "Now"},
	{Label: "next lesson", Re: regexp.MustCompile(`(?i)\bnext\s+lesson\b`), Replacement: "later"},
	{Label: "next module", Re: regexp.MustCompile(`(?i)\bnext\s+module\b`), Replacement: "later"},
	{Label: "in the next lesson", Re: regexp.MustCompile(`(?i)\bin\s+the\s+next\s+lesson\b`), Replacement: "later"},
	{Label: "you've seen the plan", Re: regexp.MustCompile(`(?i)you['’]?ve\s+seen\s+the\s+plan\s*;?\s*`), Replacement: "Now, "},
	{Label: "let's anchor", Re: regexp.MustCompile(`(?i)let['’]?s\s+anchor`), Replacement: "Let's ground"},
	{Label: "no magic", Re: regexp.MustCompile(`(?i)\bno\s+magic\b`), Replacement: "this is engineered infrastructure"},
	{Label: "no sorcery", Re: regexp.MustCompile(`(?i)\bno\s+sorcery\b`), Replacement: "this is engineered infrastructure"},
	{Label: "your next hop", Re: regexp.MustCompile(`(?i)\byour\s+next\s+hop\b`), Replacement: "the next step"},
	{Label: "bridge-in", Re: regexp.MustCompile(`(?i)\bbridge[-\s]?in\b`), Replacement: ""},
	{Label: "bridge-out", Re: regexp.MustCompile(`(?i)\bbridge[-\s]?out\b`), Replacement: ""},
	{Label: "recommended drills", Re: regexp.MustCompile(`(?i)\brecommended\s+drills\b`), Replacement: "practice"},
	{Label: "reveal answer", Re: regexp.MustCompile(`(?i)\breveal\s+answer\b`), Replacement: "answer"},
	{Label: "wrap-up", Re: regexp.MustCompile(`(?i)\bwrap[-\s]?up\b`), Replacement: "recap"},
